...
class _TeacherDetailState extends State<TeacherDetailPage> {
  ...
  Future<void> fetchDetailTutor() async {
    ...
    List<Schedule>? listScheduleResponsive =
        await ScheduleFunctions.getScheduleByTutorId(widget.tutorId);

    listScheduleResponsive = listScheduleResponsive!.where((schedule) {
    ...
    listScheduleResponsive
        .sort((s1, s2) => s1.startTimestamp.compareTo(s2.startTimestamp));

    for (var schedule in listScheduleResponsive) {
      print(schedule.startTime);
      print(schedule.endTime);
      print(schedule.isBooked.toString());
      print(DateTime.fromMillisecondsSinceEpoch(schedule.startTimestamp));
      print(DateTime.fromMillisecondsSinceEpoch(schedule.endTimestamp));
      print("--------------");
    }
